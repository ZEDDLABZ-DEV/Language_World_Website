...
const WHATSAPP_HREF =
  'https://wa.me/919888600394?text=Hi!%20LANGUAGE%20WORLD%20CANADA';
const TOOLTIP_TEXT = 'We are available! Click here to chat';
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes wa-pulse {
          0%   { box-shadow: 0 0 0 0 rgba(0, 231, 133, 0.55); }
          70%  { box-shadow: 0 0 0 18px rgba(0, 231, 133, 0); }
          100% { box-shadow: 0 0 0 0 rgba(0, 231, 133, 0); }
        }
        .wa-float-btn {
          position: fixed;
          bottom: 20px;
        ...
        .wa-float-btn[wa-tooltip]:hover::before {
          ...
          animation: wa-fade-in 250ms ease;
          z-index: 1;
          pointer-events: none;
        }
